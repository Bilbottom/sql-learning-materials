...
>
> The batch data contains information for all records regardless of whether the records have changed, but this particular pipeline should only process records that have changed so that all the table metadata is correct.
